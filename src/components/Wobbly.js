...
const Wobbly = () => {
    ...
    let surfaces;
    let palleteNum = 0;
    const palleteFirst = ['0cf', '0fc', 'ff0', 'f0c', 'c0f'];
    const palletes = [
        ['000', 'ff0', 'f0f', '0ff', 'fff'],
        ['000', 'fff', '000', 'fff', '000'],
        ['333', '666', '999', 'ccc', 'fff'],
    ...
    useEffect(() => {
        ...
        Point.prototype.move = function () {
            ...
            let dx = this.x * width - mouseX / scale,
        ...
        Surface.prototype.draw = function () {
            let p = this.points[totalPoints - 1],
                cx,
                cy;
        ...
        function resizeSurfaces() {
            ...
            totalPoints = Math.round(Math.clamp(Math.pow(Math.random() * 8, 2), 16, window.innerWidth / 35));
